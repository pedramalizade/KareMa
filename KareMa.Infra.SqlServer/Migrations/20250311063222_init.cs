...
namespace KareMa.Infra.SqlServer.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Experts",
                columns: new[] { "Id", "AppUserId", "Balance", "BankCardNumber", "Bio", "BirthDate", "CreatedAt", "FirstName", "Gender", "Image", "IsConfirm", "IsDeleted", "LastName", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, 2, 0m, "1234123412341234", "تخصص هام توی زمینه خودم عالیه", new DateTime(1999, 10, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 2, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "علی", 2, "\\AdminTemplate\\images\\user\\placeholder.jpg", true, false, "کریمی", "09362356998" },
                    { 2, 4, 0m, "1234123412341234", "میتونید بهم اعتماد کنید توی انجام کار ها", new DateTime(1999, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 2, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "سارا", 1, "\\AdminTemplate\\images\\user\\placeholder.jpg", true, false, "خاتمی", "09362357998" }
                });
